...
/*Windows x64 uses the LLP64 programming model, 
in which int and long remain 32 bit.
Need use intptr_t to represent a 64bit pointer*/
#ifdef WIN64
...
#define _VERSION_STR_  "IBM Spectrum LSF/HPC AlphaServer SC V2.6 UK1"
#elif defined(DIST_HPC)
#define _VERSION_STR_  "IBM Spectrum LSF HPC 7.0 for Dist System"
#elif defined(OTTAWA)
#define _VERSION_STR_  "IBM Spectrum Lava 7.0"
#else
#define _VERSION_STR_  "IBM Spectrum LSF 10.1"
#endif

#if defined(LSF2_25) && !defined(LinuxQsNet)
#define _VERSION_PLATFORM_STR_  "IBM Platform LSF/HPC AlphaServer SC V2.6 UK1"
#elif defined(DIST_HPC)
#define _VERSION_PLATFORM_STR_  "IBM Platform LSF HPC 7.0 for Dist System"
#elif defined(OTTAWA)
#define _VERSION_PLATFORM_STR_  "IBM Platform Lava 7.0"
#else
#define _VERSION_PLATFORM_STR_  "IBM Platform LSF 10.1"
#endif
...
#if defined(LSF_COMMUNITY)
#define _NOTE_STR_  "  notes: IBM Spectrum LSF Community Edition \n"
#elif defined(LSF_WORKGROUP_SUITE)
#define _NOTE_STR_  "  notes: IBM Spectrum LSF Suite for Workgroups \n"
#elif defined(LSF_HPS)
#define _NOTE_STR_  "  notes: IBM Spectrum LSF Suite for HPC\n"
#elif defined(LSF_VARIANT)
#define _NOTE_STR_  "  notes: IBM Spectrum LSF Standard Edition evaluation period expires on " LSF_VARIANT "\n"
#elif defined(_UNOPTIMIZED) && defined(BUILD_NOTE)
#define _NOTE_STR_  "  notes: "BUILD_NOTE" unoptimized for debugging purposes\n" 
#elif defined(_UNOPTIMIZED)
#define _NOTE_STR_  "  notes: unoptimized for debugging purposes\n" 
#elif defined(BUILD_NOTE)
...
#ifdef BUILD_OS
#ifdef CHANGE_BINTYPE
#undef BUILD_OS
#define BUILD_OS "win-x64"
#endif
...
/* RTC 164759 - Suite Edition restrictions */
typedef enum {
...
#define _LS_PLATFORM_VERSION_ (_VERSION_PLATFORM_STR_""_BUILD_INFO_)
#define _LS_SPECTRUM_VERSION_ (_VERSION_STR_""_BUILD_INFO_)
#define _LS_VERSION_ ((isLSFPlatformCompatible()) ? _LS_PLATFORM_VERSION_ : _LS_SPECTRUM_VERSION_)
...
#define LSF_XDR_VERSION9_1_1_1      28
#define LSF_XDR_VERSION9_1_2        29
#define LSF_XDR_VERSION9_1_3        30
#define LSF_XDR_VERSION9_2          31
...
#define EGO_XDR_VERSION_1_2_6       LSF_XDR_VERSION9_1_1_1
#define EGO_XDR_VERSION_1_2_7       LSF_XDR_VERSION9_1_2
#define EGO_XDR_VERSION_1_2_10       LSF_XDR_VERSION9_1_3

/* EGO_XDR_VERSION_1_2_10 in ego1_2_mainline (released as LSF9.1.3) is already
   defined to value 30, which is conflict with EGO_XDR_VERSION_2_0 value here.
   So change EGO_XDR_VERSION_2_0 from old value "30" to new value.
   */
#define EGO_XDR_VERSION_2_0          32
#define EGO_XDR_VERSION_3_1          33

#define LSF_XDR_VERSION10_1          34

#define EGO_XDR_VERSION_3_2          LSF_XDR_VERSION10_1
...
extern int isLSFPlatformCompatible(void);
...
#define NGPUS          NBUILTINDEX     /**< ngpus resource index. */
#define NGPUS_PHYSICAL NBUILTINDEX+1   /**< ngpus_physical resource index. */
#define USR1           11 /**< */
#define USR2           12 /**< */
/*@}*/
...
#define   REXF_CONTAINER_SIGKILL   0x00002000   /**< Remember SIGKILL to job level container */
...
#define NORMALIZE     0x04 /**< Normalize CPU load indices. If NORMALIZE is 
                            ...
                            * normalized. See Administering IBM Spectrum LSF for
...
#define EFFECTIVE     0x100 /**< If EFFECTIVE is set, then the CPU run queue 
                             ...
                             * effective load. See Administering IBM Spectrum LSF
...
#define REQ_FOR_LOCAL 0x40000  /* request for local(PIM/LIM) processing */
...
#define LIM_LOCKEDU_RMS 0x80000000 /**< This bit is only used with in
                                    ...
                                    * to close the host.*/
#define LIM_GPUSCH     0x10000000  /**< LIM support GPU scheduling */                                    
                                   /* Refer to Kite#29531. */
/*@}*/
...
#define OBJTYPE_BRIDGE  (OBJTYPE_UNKNOWN+9)
#define OBJTYPE_PCI_DEVICE   (OBJTYPE_UNKNOWN+10)
#define OBJTYPE_LAST    (OBJTYPE_UNKNOWN+11)
...
#define ATTR_KEY_PCI_BUSID   (ATTR_KEY_UNKNOWN+11)
#define ATTR_KEY_AVAIL_GPU_NUM    (ATTR_KEY_UNKNOWN+12)
#define ATTR_KEY_AVAIL_NODE_POS   (ATTR_KEY_UNKNOWN+13)
#define ATTR_KEY_SUP_GPUTOPO      (ATTR_KEY_UNKNOWN+14)
#define ATTR_KEY_LAST   (ATTR_KEY_UNKNOWN+15)
...
typedef int (*xtree_node_cntl2)(void *, void *);
...
#define BIND_OPT_LIM         0x0001
#define BIND_OPT_MBD         0x0002 
#define BIND_OPT_MBSCHD 0x0004
/** 
 * thread/process Tags of mbd, lim, mbschd
 *  options 
 */
/*@{*/	

#define NONE_PROC_TAG   0
#define MBD_PROC_TAG    1
#define MBSCHD_PROC_TAG 2
#define LIM_PROC_TAG    3

#define TAGID_MAIN   0
#define TAGID_ESTDRV 1
#define TAGID_CONN   2
#define TAGID_LOG    3
#define TAGID_ESTIMATOR 4
#define TAGID_UDP 5
#define TAGID_OTHER   6
/*@}*/

/**
 * \brief  minimal required cores number 
 *  to enable feature LSF_INTELLIGENT_CPU_BIND
 */ 
#define MIN_REQUIRED_CORE_NUM 8 

/**
 * \brief  Cpu binding information
 */ 
struct cpuBindInfo_t {
    int   daemon;
    int   tagId;
    int   ncpus;      /* number of cpus allocated,
                       * translated allocated core
                       * to cpus */
    int  *cpus;       /* cpu list */
};

struct cpuBindInfoList_t {
    int    num;               /** < Number of cpu binding information */
    struct cpuBindInfo_t *cpubindinfos; /** < Array of cpu bind Information */
};

extern int gCPUBindingEnabled;
extern int ls_bindinfo(int, struct cpuBindInfoList_t*);
...
typedef struct _hostGpuNvlinkMap {
    ...
    int gpuId;                      /*GPU id of this GPU*/
}hostGpuNvlinkMap;

typedef struct _hostGpuNvlinkInfo {
    int gpuC;                       /*total GPU count*/
...
typedef struct hostGpuAttr {
    ...
    char                    gModel[GPU_NAME_LEN];        /* The model name of GPU */
    char                    gFactor[GPU_NAME_LEN];       /* The factor of GPU */
...
typedef struct hostGpuLoad {
    int                     gMode;         /* The mode of GPU - SHARE or EXCLUSIVE */
    float                   gUsedMem;      /* The used memory of GPU (MB) */
    hostGpuStatus_t         gStatus;       /* The status of the GPU */
    char                    gError[GPU_ERROR_MSG_LEN];   /* The GPU error string of GPU*/
    int                     gPstate;       /* The performance state of GPU*/
    int                     gTemp;         /* The temperature of GPU*/
...
typedef struct hostGpuInfo {
    char           hostName[MAXHOSTNAMELEN]; /**<  The host name*/
    char           gDriver[GPU_NAME_LEN];    /**<  The driver of GPU*/
    int            gpuC;                     /* The total number of GPU devices */
    float          gMaxFactor;               /* The max factor of GPU on a host */
    float          gpu_shared_avg_ut;        /* The shared used average ut for all GPU on a host */
    float          gpu_shared_avg_mut;       /* The shared used average memory ut for all GPU on a host */
    hostGpuAttr_t  *gpuAttrV;                /* The array of all GPU attributes */
    hostGpuLoad_t  *gpuLoadV;                /* The array of all GPU load */
    lsf_topology_t gpuTop;                   /* The GPU top on a host*/
    int            gNumkvs;                  /* The number of KVPs */
    keyValue_t     *gKvs;                    /* KVPs */
} hostGpuInfo_t;
...
#define PLATFORM_LSFXL           27     /**<  IBM Spectrum LSF/XL license*/
...
# define INET6_ADDRSTRLEN 46
    ...
    time_t jointime;            /* host join cluster time stamp. */
    int isVNode;
};
...
struct lsConf {
    ...
    int     hasIncludeFile;  /*if has the include file, set to 1*/
};
...
/**
 * \brief Informtion about job's current hardware counters
 */
enum hwCounters{
    HOST_UNHALTED_CORE_CYCLES,
    HOST_INSTRUCTIONS_RETIRED,
    HOST_UNC_LLC_MISS_READ,
    HOST_UNC_QMC_WRITES_FULL_ANY,
    HOST_GFLOPS,
    MAX_HARDWARE_COUNTERS
};

/* number of core hardware counters */
#define MAX_CORE_HARDWARE_COUNTERS_IDX  2
/* compatibility with LSF 9.1.2 */
#define MAX_HARDWARE_COUNTERS_912       4

/* hardware counter array */
typedef double HardwareCounters_T[MAX_HARDWARE_COUNTERS];
typedef LS_UNS_LONG_INT InstHardwareCounters_T[MAX_HARDWARE_COUNTERS];
...
struct KVPair {
    int numKVP; /** The number of Key-value pairs */
...
typedef struct jRusage {
    ...
    long stime;       /**< Cumulative total system time in seconds */
    ...
    int nthreads;     /**< Number of currently active threads in given 
		       * process groups. */
    float unused_power; /**< unused job power which lack of precision */
    double power; /**< job power usage */
    HardwareCounters_T hwCounters; /**< job hardware counters */
    int nHwCounters;  /**< Number of job hardware counters */
    /*ASC PRD5 238941*/
    float cpuUT; /**<CPU usage,  percentage>*/
    long io; /**<Total transferred IO data KB>*/
    float ioRate; /**<Instantaneous I/O rate, KB/s>*/
    long diskIO;/**<Total transferred Disk IO data KB>*/
    float diskIORate; /**<Instantaneous Disk I/O rate, KB/s>*/
    long deltaIO; /**<Delta IO data KB>*/
    long deltaDiskIO; /**<Delta Disk IO data KB>*/
    struct KVPair KVP; /**<Key-value pairs for extension>*/
}jRusage_t;
...
struct hRusage {
    ...
    long stime;        /**< Cumulative total system time in seconds on given host*/
...
struct funcProfileParams {

#define PROFILE_FLAG_ENABLE    0x001
#define PROFILE_FLAG_TIMELEVEL 0x002
#define PROFILE_FLAG_INTERVAL  0x004
#define PROFILE_FLAG_THRESHOLD 0x008
#define PROFILE_FLAG_LOGLEVEL  0x010
#define PROFILE_FLAG_LOGFUNC   0x020
    ...
    float          threshold;
    int            logLevel;
    profileLogFunc logfunc;
};

extern int    funcProfile_parseConfig(char *, struct funcProfileParams *, char **);
extern int    funcProfile_init(struct funcProfileParams *);
extern void   funcProfile_enterFunc(int *);
extern void   funcProfile_leaveFunc(int *, const char *, long, long, long);
extern int    funcProfile_trackTime(int);
...
{ int doProfile = funcProfile_trackTime(level); \
  if ((clockticks > 0) \
      ...
      if (doProfile) { \
          ...
          long _utime; \
          long _stime; \
          _rtime = (_after.tv_sec - _before.tv_sec)*1000000 + \
                   (_after.tv_usec - _before.tv_usec); \
          _utime = (1000000*(_buf2.tms_utime - _buf.tms_utime))/clockticks; \
          _stime = (1000000*(_buf2.tms_stime - _buf.tms_stime))/clockticks; \
          funcProfile_leaveFunc(&timeInst, # func , \
                                _rtime, _utime, _stime); \
      } \
  } else { \
      func; \
      tv.rtime = 0.0; \
...
#define TIMEIT_START_BLOCK_SUM(level) \
{ struct timeval _before, _after; \
  struct timezone _tz; \
  if (timinglevel > level) { \
      gettimeofday(&_before, &_tz); \
...
#define TIMEIT_END_BLOCK_SUM(level, acc) \
  if (timinglevel > level) { \
      float rt; \
      gettimeofday(&_after, &_tz); \
...
{ int doProfile = 0; \
  ...
  struct timezone _tz; \
  static int timeInst = 0; \
  doProfile = funcProfile_trackTime(level); \
  if ((clockticks > 0) \
       && ((timinglevel > level) || doProfile)) { \
      if (doProfile) { \
          funcProfile_enterFunc(&timeInst); \
...
#define TIMEIT_END_BLOCK(level, name) \
  if ((clockticks > 0) \
      ...
      if (timinglevel > level) { \
          ...
          ls_syslog(LOG_INFO, \
"L%d %s rtime %.2f ms, utime %.2f ms, stime %.2f ms", \
                    level, name, rt, ut, st); \
      } \
      if (doProfile) { \
          long _rtime; \
          ...
          _utime = (1000000*(_buf2.tms_utime - _buf.tms_utime))/clockticks; \
          _stime = (1000000*(_buf2.tms_stime - _buf.tms_stime))/clockticks; \
          funcProfile_leaveFunc(&timeInst, name, _rtime, _utime, _stime); \
      } \
  } \
}
...
#define LC2_HOST_POWER                  66 /* Log message for power policy */
#define LC2_FANOUT                      67 /* Log msg related to fanout framework */
#define LC2_BLAUNCH                     68 /* Log msg related to blaunch framework */
#define LC2_EAS                         69 /* Log msg related to EAS */
#define LC2_DAS                         70 /* data aware scheduling */
#define LC2_EST                         71 /* Log msg related to start time prediction */
#define LC2_JOBINFO_CACHE               72 /* Jobinfo cache #20541 */
#define LC2_RC               			73 /* Host Factory/ Resource Connector #96549 */
#define LC2_DOCKER                      74 /* docker job */
#define LC2_CONTAINER                   74 /* all container jobs including docker, so set same value to LC2_DOCKER */
#define LC2_CSM                         75 /* CSM */
...
#define LSF_EVENT_EBROKERD_DOWN     17 /* ebrokerd down abnormally. */ 
/*
 ...
 * Administering IBM Spectrum LSF for more information about resource requirement
 ...
 * IBM Spectrum LSF for more information about resource requirement expressions.
...
extern void set_loadinfo_UseTcp(void); /*SUP_BY_DEV #223527*/
/**
 ...
 * 
 * resreq is an output parameter; you either specify the pointer to the character array or leave it as NULL.
 * If taskname is eligible for remote execution, the resource requirements associated with taskname
 * in the remote task lists are copied into resreq. If resreq is NULL, the API automatically allocates
 * memory. The API calling function must free the memory to which the resreq points.
 * If no resource requirements are associated with taskname, an empty string is copied into resreq
 ...
 * @param **resreq The resource requirements associated with the "taskname" task. If no resource
 * requirements are associated with taskname and resreq is not NULL, an empty string is copied into resreq.
 * If resource requirements are associated with taskname and resreq is not NULL, the resource requirements
 * that are associated with taskname are copied into resreq. If resource requirements are associated with 
 * taskname and resreq is NULL, LSF allocates new memory space to store resource requirements 
 * that are associated with taskname. The API calling function needs to free this memory.
 ...
 * \n See Administering IBM Spectrum LSF for a description of the resource requirement
 * string. 
 * 
 * <b>Data Structures:</b>
 * \par
 ...
 * IBM Spectrum LSF for information about resource requirement string syntax. If this
...
extern int getAdminID_r(uid_t * uid, gid_t *gid);
#endif
...
extern int ls_isASCEntitled P_(());
extern int ls_isConductorEntitled P_(());
...
extern void SetOomProtect(int enableLog);
extern void CancelOomProtect(void);
#endif
...
typedef enum {
    ...
    LiC_ACTION_SET,                /**< Equivalent to Lic_ACTION_UPDATE and if not existing, perform LiC_ACTION_CREATE */    
...
#ifndef fork_safe
#define fork_safe fork
#endif


#endif /*#if defined (OS_HAS_THREAD)*/
...
/*ASC PRD5 238941*/
extern int buildPIMFileFormat(char* );
/*
 * The official build server doesn't define __USE_ISOC99 by default in stdio.h
 * Copy ULLONG_MAX definition from limits.h
 * */
#ifndef ULLONG_MAX
#ifdef _WIN64
#define ULLONG_MAX    18446744073709551615
#elif _WIN32
#define ULLONG_MAX    4294967295
#else
...
#define FLOAT_DEVIATION 0.00000000001
#endif /* _EGO_H_ */
...
*/
/*Copyright string*/
#define LSF_PRODUCT_COPYRIGHT_STR "Copyright IBM Corp. 1992, 2016. All rights reserved.\n" \
                                  "US Government Users Restricted Rights - Use, duplication " \
                                  "or disclosure restricted by GSA ADP Schedule Contract with IBM Corp."

/*Product name string*/
#define LSF_NAME_STR "IBM Spectrum LSF "
#ifdef IDENTIFIER
...
*/
#define LSF_PRODUCT_MAJOR_VERSION               10
#define LSF_PRODUCT_MINOR_VERSION               1
#define LSF_PRODUCT_MAINTAIN_VERSION            0
#define LSF_PRODUCT_FOURTH_VERSION              0

#define LSF_PRODUCT_MAJOR_VERSION_STR           "10"
#define LSF_PRODUCT_MINOR_VERSION_STR           "1"
#define LSF_PRODUCT_MAINTAIN_VERSION_STR        "0"
...
#define _VERSION_STR_LSID_  "IBM Spectrum LSF 10.1.0.0"
